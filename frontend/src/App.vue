  ...
  <v-app>
    ...
    <v-main>
      <v-container fluid class="pa-4 pa-md-6">
        ...
        <v-card v-if="isAuthenticated && !['/conversations', '/health', '/autopilot'].includes(route.path)" class="mb-6 global-stats-panel">
          <div
        ...
        <!-- 统计卡片 - 玻璃拟态风格 -->
        <v-row v-if="!['/conversations', '/health', '/autopilot'].includes(route.path)" class="mb-6 stat-cards-row">
          <v-col cols="6" sm="4">
        ...
        <!-- 操作按钮区域 - 现代化设计 -->
        <div v-if="!['/conversations', '/health', '/autopilot'].includes(route.path)" class="action-bar mb-6">
